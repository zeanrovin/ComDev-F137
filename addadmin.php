...
?>
	...
	<html>
	<head>
		<title>Xavier University-Governance and Leadership Institute</title>
		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="home.php"><b>GLI</b></a>
				</div>
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					
					<ul class="nav navbar-nav navbar-right">
						<li><a href="map.php"><span class="glyphicon glyphicon-globe"></span> Map</a></li>
						<li><a href="add.html"><span class="glyphicon glyphicon-plus-sign"></span> Add</a></li>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<h4 class="modal-title">Add Admin</h4>
					...
					<div class="modal-body">
						<p>Adding User Admin Successful!</p>
			<div class="modal-footer">
						<a href="home.php" class="btn btn-primary" input type="submit" value="Submit" >Proceed</a>
						</div>
			</div>
		</div>
  </div>
