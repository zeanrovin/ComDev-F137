						...
						<li><a href="logout.php"><span class="glyphicon glyphicon-log-out"></span> Sign Out </a></li>
                                ...
                                <div id="generalTabContent" class="tab-content">
                                    <div id="tab-1" class="tab-pane fade in active">
                                        <iframe src="form137v.php?edit_key=<?php echo $edit_key;?>&grade=7" frameborder="0" style="overflow: hidden; height: 100%;
        										width: 100%; position: absolute;" height="100%" width="100%"></iframe>
                                    </div>
                                    <div id="tab-3" class="tab-pane fade in">

                                        <iframe src="form137v.php?edit_key=<?php echo $edit_key;?>&grade=8" frameborder="0" style="overflow: hidden; height: 100%;
        										width: 100%; position: absolute;" height="100%" width="100%"></iframe>

                                    </div>
                                    <div id="tab-4" class="tab-pane fade in">

                                        <iframe src="form137v.php?edit_key=<?php echo $edit_key;?>&grade=9" frameborder="0" style="overflow: hidden; height: 100%;
        										width: 100%; position: absolute;" height="100%" width="100%"></iframe>

                                    </div>
                                    <div id="tab-5" class="tab-pane fade in">

                                        <iframe src="form137v.php?edit_key=<?php echo $edit_key;?>&grade=10" frameborder="0" style="overflow: hidden; height: 100%;
        										width: 100%; position: absolute;" height="100%" width="100%"></iframe>

                                    </div>
                                    <div id="tab-6" class="tab-pane fade in">

                                        <iframe src="form137c.php?edit_key=<?php echo $edit_key;?>&grade=11" frameborder="0" style="overflow: hidden; height: 100%;
        										width: 100%; position: absolute;" height="100%" width="100%"></iframe>

                                    </div>
                                    <div id="tab-7" class="tab-pane fade in">

                                        <iframe src="form137v.php?edit_key=<?php echo $edit_key;?>&grade=12" frameborder="0" style="overflow: hidden; height: 100%;
        										width: 100%; position: absolute;" height="100%" width="100%"></iframe>
